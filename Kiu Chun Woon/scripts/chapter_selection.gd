...
const CHAPTER_ONE_SCENE := (
	"res://Kiu Chun Woon/scenes/chapter_1_rhythm.tscn"
)

const CHAPTER_TWO_SCENE := (
	"res://Lau Kah Kei/scenes/corridor.tscn"
)

const CHAPTER_THREE_SCENE := (
	"res://Lew Jia Jia/scenes/Chapter3_RoomB13.tscn"
)

const CHAPTER_FOUR_SCENE := (
	"res://Tay Hong Fei/scene/Chapter 4-1.tscn"
)
...
func _on_chapter_four_pressed() -> void:
	...
	GameState.new_game_started = true
